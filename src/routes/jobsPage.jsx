  ...
  return (
    <div className="">
      ...
      <div className="w-[1216px] mx-auto ">
        <div className="mt-6 flex items-center justify-between pb-10 border-b-[1px] border-[#D0D1D1]">
          {array.map((item, index) => {
            return (
              <div
                key={index}
                className="flex justify-between items-center gap-[72px] border-[1px] border-[#E6E7E7] rounded py-4 px-[14px]"
              >
                <div>{item}</div>
